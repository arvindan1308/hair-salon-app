        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <Container style={{ backgroundColor: 'white' }}>
            ...
            <View>
              ...
              <View style={{ flex: 1, paddingTop: 20 }}>
                ...
                >
                  ...
                  <Picker.Item label="Dabbu " value="Dabbu " />
                </Picker>
                <View>
                  <TouchableOpacity
            ...
            <Container style={{
              ...
              marginTop: 200, marginBottom: 340, marginLeft: 10
            }}>
              <Content padder>
                <Card transparent>
                  <CardItem>
                    <Left>
                      ...
                      <Body style={{ alignItems: 'flex-start' }}>
                        <Text style={{ fontSize: 22 }}>
                          SF - 24, 2nd Flr., Viviana Mall, Eastern Express Hwy, next to Jupiter Hospital,
                          Laxmi Nagar, Thane West, Thane, Maharashtra 400606
                        </Text>
                      </Body>
                    </Left>
                  </CardItem>
