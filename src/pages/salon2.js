...
class salon2 extends Component {
  constructor(props, context) {
    super(props, context)
    this.state = { time: '', stylist: '', salon: 'Enrich Salon',date:'15/10/2020',}
    this.onValueChange = this.handleValueChange.bind(this)
  }
  saveToDB = () => {
    Firebase.database().ref('/Book/s2').push({
  ...
  deleteToDB = () => {
    Firebase.database().ref('/Book/s2').remove()
      .then(
          ...
          <Container style={{ backgroundColor: 'white' }}>
            ...
            <View>
              ...
              <View style={{ flex: 1, paddingTop: 20 }}>
                  ...
                  <ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
                    <View style={{ height: 130, marginTop: 20 }}>
                      <View style={{ height: 150, width: 150, marginLeft: 20, borderWidth: 0.5, borderColor: 'grey' }}>
                        <Image source={require('../../images/pic4.jpg')}
                    ...
                    <View style={{ height: 130, marginTop: 20 }}>
                      <View style={{ height: 150, width: 150, marginLeft: 15, borderWidth: 0.5, borderColor: 'grey' }}>
                        <Image source={require('../../images/pic6.jpg')}
                          style={{ flex: 1, height: null, width: null, resizeMode: 'cover' }}
                        />
                      </View>
                    </View>
                    <View style={{ height: 130, marginTop: 20 }}>
                      <View style={{ height: 150, width: 150, marginLeft: 15, borderWidth: 0.5, borderColor: 'grey' }}>
                        <Image source={require('../../images/pic7.jpg')}
                          style={{ flex: 1, height: null, width: null, resizeMode: 'cover' }}
                        />
                      </View>
                    </View>
                    <View style={{ height: 130, marginTop: 20 }}>
                      <View style={{ height: 150, width: 150, marginLeft: 10, borderWidth: 0.5, borderColor: 'grey' }}>
                        <Image source={require('../../images/pic12.jpg')}
                ...
                >
                  <Picker.Item label="Adi" value="Adi" />
                  <Picker.Item label="Abhishek" value="Abhishek" />
                  <Picker.Item label="Rahul" value="Rahul" />
                  <Picker.Item label="Pankaj" value="Pankaj" />
                  <Picker.Item label="Rutuja" value="Rutuja" />
                </Picker>
                <View>
                  <TouchableOpacity
                  ...
                  <CardItem>
                    <Left>
                      ...
                      <Body style={{ alignItems: 'flex-start' }}>
                        ...
                        Shop No. 2, Ground & First Floor, New Shankar Niwas, SV Rd, Navpada, 
