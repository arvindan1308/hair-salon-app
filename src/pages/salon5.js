...
class salon5 extends Component {
  constructor(props, context) {
    super(props, context)
    this.state = { time: '', stylist: '',salon: 'NailDistrict.In', date:'15/10/2020',}
    this.onValueChange = this.handleValueChange.bind(this)
  }
  saveToDB = () => {
    Firebase.database().ref('/Book/s5').push({
  ...
  deleteToDB = () => {
    Firebase.database().ref('/Book/s5').remove()
      .then(
          ...
          <Container style={{ backgroundColor: 'white' }}>
            ...
            <View>
              ...
              <View style={{ flex: 1, paddingTop: 20 }}>
                ...
                >
                  <Picker.Item label="Aavi" value="Aavi" />
                  <Picker.Item label="Ravi" value="Ravi" />
                  <Picker.Item label="Bunny" value="Bunny" />
                  <Picker.Item label="Parv" value="Parav" />
                  <Picker.Item label="Debu" value="Debu" />
                </Picker>
                <View>
                  <TouchableOpacity
            ...
            <Container style={{
              ...
              marginTop: 220, marginBottom: 370, marginLeft: 10
            }}>
              <Content padder>
                <Card transparent>
                  <CardItem>
                    <Left>
                      ...
                      <Body style={{ alignItems: 'flex-start' }}>
                        ...
                        21, UG, DLF Mega Mall, Golf Course Road Gurgaon, Haryana 122001
                        </Text>
                      </Body>
                    </Left>
                  </CardItem>
